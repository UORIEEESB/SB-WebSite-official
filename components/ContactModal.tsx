  ...
  return (
    ...
    >
      <Dialog.Panel className="relative bg-white rounded-2xl shadow-xl ring-1 ring-gray-200 w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <Dialog.Title className="text-3xl font-semibold mb-6 py-4 text-center text-red-700">Send Us A Message</Dialog.Title>
        ...
        {submitted ? (
          <div className="text-center">
            ...
            <button
              onClick={handleReset}
              className="inline-block px-6 py-2 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 transition"
            >
          ...
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-4 text-gray-700 text-sm">
              ...
              <label key={name} className="flex flex-col">
                ...
                <input
                  ...
                  className={`border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 transition ${
                    errors[name] ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-red-500'
                  }`}
                />
            ...
            <label className="flex flex-col">
              ...
              <textarea
                ...
                className={`border rounded-lg px-3 py-2 resize-none focus:outline-none focus:ring-2 transition ${
                  errors.message ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 focus:ring-red-500'
                }`}
              />
            ...
            <button
              ...
              className="mt-3 bg-red-600 text-white py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition disabled:opacity-60"
            >
