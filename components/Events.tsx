  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <Link
          href="/news"
          className="text-4xl font-extrabold mb-12 text-center text-white transition-all duration-300 hover:text-red-400 hover:drop-shadow-[0_0_8px_#FF0000]"
        >
          News & Events
        </Link>
      </div>
      ...
      <div className="relative overflow-hidden">
        <div ref={trackRef} className="marquee-track flex gap-6 w-max">
          {[...events, ...events].map(({ title, date, description, image, url }, index) => (
            <div
              key={index}
              className="bg-neutral-800 rounded-lg overflow-hidden shadow-lg hover:shadow-red-600 transition-shadow w-80 flex-shrink-0"
            >
              ...
              <div className="p-6 text-white">
                ...
                <p className="text-sm text-red-400 mb-3">{date}</p>
