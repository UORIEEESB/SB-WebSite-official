  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-black bg-opacity-70 backdrop-blur-md z-50 shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 md:px-10 h-16">
        ...
        <Link
          href="/"
          className="block relative w-40 sm:w-48 h-14 sm:h-16" 
        >
        <Image
          src="/images/IAS Logo white.png"
          alt="IEEE UoR IAS Logo"
          fill
        ...
        <ul className="hidden md:flex space-x-8 text-white font-medium text-lg items-center">
          ...
          >
            <button className="hover:text-green-500 transition flex items-center gap-1">
              Chapters ▾
            </button>
            {isDropdownOpen && (
          ...
          <li>
            <button
              ...
              className="hover:text-green-500 transition flex items-center gap-1 text-white"
            >
              Contact
              <Mail className="w-5 h-5 animate-wiggle text-green-400" />
            </button>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-black bg-opacity-90 backdrop-blur-md">
          <ul className="flex flex-col space-y-4 px-6 py-4 text-white font-medium text-lg">
            <li>
              <Link href="/" className="hover:text-green-500 transition" onClick={() => setMobileMenuOpen(false)}>Home</Link>
            </li>
            <li>
              <a href="#about" className="hover:text-green-500 transition" onClick={() => setMobileMenuOpen(false)}>About</a>
            </li>
            <li>
              <a href="/news" className="hover:text-green-500 transition" onClick={() => setMobileMenuOpen(false)}>News</a>
            </li>

            {/* Sub Chapters */}
            <li>
              <details className="group">
                <summary className="flex justify-between items-center cursor-pointer hover:text-green-500 transition">
                  Sub Chapters ▾
                </summary>
