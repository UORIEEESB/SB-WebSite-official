      ...
      <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start gap-10 sm:gap-16 mt-12 mb-8">
        {[
          ...
          <div key={label} className="flex flex-col items-center relative">
            <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center rounded-full before:absolute before:inset-0 before:rounded-full before:bg-orange-500/30 before:blur-xl before:animate-pulse">
              <span className="text-3xl sm:text-4xl font-extrabold text-orange-400 z-10">
