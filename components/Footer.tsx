  ...
  return (
    <footer className="relative bg-white/10 backdrop-blur-md text-white w-full mt-20 overflow-hidden rounded-t-3xl border-t border-white/20 shadow-inner">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 py-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        {/* Address */}
        <div>
          <h4 className="text-2xl font-bold text-green-400 mb-5">Address</h4>
        ...
        {/* Menu */}
        <div>
          <h4 className="text-2xl font-bold text-green-400 mb-5">Menu</h4>
          <ul className="space-y-3 text-base text-gray-200">
            ...
            <li><a href="https://drive.google.com/file/d/172v3PLGgixQk8n6n5cCbpZPH-cerdz-3/view?usp=sharing" className="hover:text-green-400 transition">Brand Toolkit</a></li>
          </ul>
        </div>

        {/* Contact */}
        <div>
          <h4 className="text-2xl font-bold text-green-400 mb-5">Contact</h4>
        ...
        {/* Social Media */}
        <div>
          <h4 className="text-2xl font-bold text-green-400 mb-5">Follow Us</h4>
