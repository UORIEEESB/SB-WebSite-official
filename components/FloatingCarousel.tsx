...
useEffect(() => {
  ...
  return (
    <div className="fixed right-[-200px] top-1/2 -translate-y-1/2 z-40 hidden md:block">
      <div className="relative w-[520px] h-[520px] rounded-full border-[6px] border-green-600 shadow-[0_0_50px_#66FFB2] bg-black bg-opacity-80 backdrop-blur-md flex items-center justify-center">
...
<AnimatePresence mode="wait">
  {sections[activeIndex] && (
    ...
    >
      ...
      <style jsx>{`
        .animate-glow {
          filter: drop-shadow(0 0 8px #66FFB2);
